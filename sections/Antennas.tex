...
\begin{tabular}{|l|c|c|}
	...
	\hline Time averaged radiated Power & $S(r,\phi,\theta)=\int_{0}^{T}\vec{E}\hspace{0.1cm} x\hspace{0.1cm} \vec{H}dt $ & $Z_0 \frac{I_0^2}{8r}(\frac{d}{\lambda})^2 \hspace{0.1cm} sin^2 \theta$ \\
